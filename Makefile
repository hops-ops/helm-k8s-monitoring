...
PACKAGE ?= helm-k8s-monitoring
XRD_DIR := apis/k8smonitorings
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/k8smonitorings/standard.yaml
...
EXAMPLES := \
    examples/k8smonitorings/minimal.yaml:: \
    examples/k8smonitorings/standard.yaml::
...
render\:%:
	@example="examples/k8smonitorings/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
